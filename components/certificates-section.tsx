...
const certificates = [
  ...
  },
  {
    ...
    category: "DevOps",
    icon: "⚙️",
    previewUrl: "https://www.coursera.org/account/accomplishments/verify/VHCZZVAWRYJ1?utm_source=ios&utm_medium=certificate&utm_content=cert_image&utm_campaign=sharing_cta&utm_product=course",
  },
  {
    title: "Data Science",
    issuer: "Coursera",
